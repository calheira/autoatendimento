$(document).ready(function(){
  ...
  $("#alvara").on("click", function(){
    doc.pedidos += "<br>- SEJA EXPEDIDO ALVARÁ JUDICIAL através do Sistema SISCONDJ, referente ao valor depositado no evento ______, informando ainda seus DADOS BANCÁRIOS:<br>BANCO ______________,<br> Agência:___________,<br>Conta CorrentePoupança:______________,<br> Titular: ____________,<br>CPF:_______________. "
  ...
  $("#execucao").on("click", function(){
    doc.pedidos += "<br>- seja iniciada a EXECUÇÃO DA SENTENÇA / ACÓRDÃO, com o ENVIO DOS AUTOS À CONTADORIA para ATUALIZAÇÃO DOS CÁLCULOS.<br> - Requeiro, também, seja realizado o BLOQUEIO DO VALOR ATUALIZADO, através dos sistemas BACENJUD e / ou RENAJUD.<br>- Em tempo, informo meus DADOS BANCÁRIOS para que SEJA EXPEDIDO ALVARÁ JUDICIAL através do Sistema SISCONDJ:<br>BANCO ______________,<br> Agência:___________,<br>Conta CorrentePoupança:______________,<br> Titular: ____________,<br>CPF:_______________."
    $("#pedido").html(doc.pedidos);
  });
